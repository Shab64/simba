...
<!-- Mirrored from themesbrand.com/velzon/html/modern/apps-ecommerce-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 26 Feb 2022 01:33:51 GMT -->
<head>
                            ...
                            <div data-simplebar style="max-height: 320px;">
                                ...
                                <div class="notification-list">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex dropdown-item notify-item py-2">
                                        <img src="{{url('assets')}}/images/users/avatar-2.jpg" class="me-3 rounded-circle avatar-xs"
                                             alt="user-pic">
                                        <div class="flex-1">
                                    ...
                                    <!-- item -->
                                    <a href="javascript:void(0);" class="d-flex dropdown-item notify-item py-2">
                                        <img src="{{url('assets')}}/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs"
                                             alt="user-pic">
                                        <div class="flex-1">
                                    ...
                                    <!-- item -->
                                    <a href="javascript:void(0);" class="d-flex dropdown-item notify-item py-2">
                                        <img src="{{url('assets')}}/images/users/avatar-5.jpg" class="me-3 rounded-circle avatar-xs"
                                             alt="user-pic">
                                        <div class="flex-1">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown ms-1 topbar-head-dropdown header-item">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                            ...
                            <img id="header-lang-img" href="{{url('assets')}}/images/flags/us.svg" alt="Header Language" height="20"
                                 class="rounded">
                        </button>
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0"
                            ...
                            <div class="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border d-grid">
                                ...
                                <a href="apps-ecommerce-checkout.html" class="btn btn-danger text-center">
                                    Checkout
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                    <div data-simplebar style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="my-3 text-center">
                                            <button type="button" class="btn btn-soft-secondary waves-effect waves-light">View
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" href="{{url('assets')}}/images/users/avatar-1.jpg"
                                 alt="Header Avatar">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="pages-profile-settings.html"><span
                                        class="badge badge-soft-warning mt-1 float-end">New</span><i
                                ...
                                <div class="table-responsive table-card">
                                    <table class="table table-borderless align-middle mb-0">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="avatar-md bg-light rounded p-1">
                                                    <img src="{{url('assets')}}/images/products/img-8.png" alt=""
                                        ...
                                        <tr>
                                            <td>
                                                <div class="avatar-md bg-light rounded p-1">
                                                    <img src="{{url('assets')}}/images/products/img-7.png" alt=""
                                                         class="img-fluid d-block">
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="avatar-md bg-light rounded p-1">
                                                    <img src="{{url('assets')}}/images/products/img-3.png" alt=""
                                                         class="img-fluid d-block">
                                                </div>
                                            </td>
                                            <td>
...
<!-- JAVASCRIPT -->
<script href="{{url('assets')}}/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
<script href="{{url('assets')}}/libs/simplebar/simplebar.min.js"></script>
<script href="{{url('assets')}}/libs/node-waves/waves.min.js"></script>
<script href="{{url('assets')}}/libs/feather-icons/feather.min.js"></script>
<script href="{{url('assets')}}/js/pages/plugins/lord-icon-2.1.0.js"></script>
<script href="{{url('assets')}}/js/plugins.js"></script>

<!-- init js -->
<script href="{{url('assets')}}/js/pages/ecommerce-product-checkout.init.js"></script>

<!-- App js -->
<script href="{{url('assets')}}/js/app.js"></script>
</body>
