                    ...
                    <div class="card">
                        <div class="card-header border-bottom-dashed">
                            ...
                            <div class="row g-4 align-items-center">
                                <div class="col-sm">
                                    <div>
                                        <h5 class="card-title mb-0">All RTO</h5>
                                    </div>
                                </div>
                                <div class="col-sm-auto">
                                    <a href="#" class="btn btn-primary">Print</a>
                                    <a href="add-RTO-quotation.blade.php" class="btn btn-primary">Quotation</a>
                                    <div class="btn-group">
                                        <a href="{{route('add-rto')}}"> <button type="button" class="btn btn-primary">
                                                Add RTO
                                            </button>
                                        </a>
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="">
                                                    <input type="text" class="form-control" id="datepicker-range"
                                                           ...
                                                           data-range-date="true" placeholder="Select date from">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-sm-4">
                                                <div class="">
                                                    <input type="text" class="form-control" id="datepicker-range"
                                                           data-provider="flatpickr" data-date-format="d M, Y"
                                                           data-range-date="true" placeholder="Select date to">
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-sm-4">
                                                <div>
                                                    <select class="form-control" data-plugin="choices" data-choices=""
                                                        ...
                                                        <option value="Block">Sold</option>
                                                        <option value="Block">Written Off</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end col-->
